...
DB_URI = environ.get("DB_URI", "mongodb+srv://Himanshu:Himanshu0987@cluster0.bwjdm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002150170559"))
...
SHORTLINK_URL = environ.get("SHORTLINK_URL", "runurl.in") # shortlink domain without https://
SHORTLINK_API = environ.get("SHORTLINK_API", "a27592d9eeeb5340c07d7df200745c3ecace94e0") # shortlink api
